<h2><a href="https://leetcode.com/problems/parse-lisp-expression/?envType=problem-list-v2&envId=recursion">736. Parse Lisp Expression</a></h2><h3>Hard</h3><hr><p>You are given a string expression representing a Lisp-like expression to return the integer value of.</p>
